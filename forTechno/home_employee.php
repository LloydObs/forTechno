            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="gender" class="form-control" placeholder="Gender" autocomplete="off" required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="number" name="contact" class="form-control" placeholder="Contact Number" autocomplete="off" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="emp_type" class="form-control" placeholder="Employee Type" autocomplete="off" required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="division" class="form-control" placeholder="Select Department" autocomplete="off" required>
