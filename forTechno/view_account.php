  ...
  <body>
    ...
    <div class="container">
      ...
      <?php
        ...
        $query  = mysqli_query($connectDb,"SELECT * from overtime");
        while($row=mysqli_fetch_array($query))
        {
          $rate   = $row['rate'];
        }

        $query  = mysqli_query($connectDb, "SELECT * from salary");
        while($row=mysqli_fetch_array($query))
        {
                ...
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
                  ...
                  <div class="form-group">
                    ...
                    <select name="deduction" class="form-control" required>
                      <option value="<?php echo $philhealth; ?>">PhilHealth</option>
                      <option value="<?php echo $providentfund; ?>">Provident Fund</option>
                      <option value="<?php echo $pagibig; ?>">Pag-Ibig</option>
                      <option value="<?php echo $SSS; ?>">SSS</option>
